...
const CUBE_FACES: [[Vertex3D; 6]; 10] = [
    ...
    // Diagonal (0, 0) -> (1, 1)
    [
        Vertex3D { position: Vector3::new(0.146_446_62, 0.99, 0.146_446_62), normal: Vector3::new(0.701, 0.0, -0.701), tex_coords: Vector2::new(0.0, 1.0) , vtype: 0 },
        Vertex3D { position: Vector3::new(0.853_553_4, 0.0, 0.853_553_4), normal: Vector3::new(0.701, 0.0, -0.701), tex_coords: Vector2::new(1.0, 0.0) , vtype: 0 },
        Vertex3D { position: Vector3::new(0.146_446_62, 0.0, 0.146_446_62), normal: Vector3::new(0.701, 0.0, -0.701), tex_coords: Vector2::new(0.0, 0.0) , vtype: 0 },

        Vertex3D { position: Vector3::new(0.146_446_62, 0.99, 0.146_446_62), normal: Vector3::new(0.701, 0.0, -0.701), tex_coords: Vector2::new(0.0, 1.0) , vtype: 0 },
        Vertex3D { position: Vector3::new(0.853_553_4, 0.99, 0.853_553_4), normal: Vector3::new(0.701, 0.0, -0.701), tex_coords: Vector2::new(1.0, 1.0) , vtype: 0 },
        Vertex3D { position: Vector3::new(0.853_553_4, 0.0, 0.853_553_4), normal: Vector3::new(0.701, 0.0, -0.701), tex_coords: Vector2::new(1.0, 0.0) , vtype: 0 },
    ],
    ...
    // Diagonal (0, 1) -> (1, 0)
    [
        Vertex3D { position: Vector3::new(0.146_446_62, 0.99, 0.853_553_4), normal: Vector3::new(-0.701, 0.0, -0.701), tex_coords: Vector2::new(0.0, 1.0) , vtype: 0 },
        Vertex3D { position: Vector3::new(0.853_553_4, 0.0, 0.146_446_62), normal: Vector3::new(-0.701, 0.0, -0.701), tex_coords: Vector2::new(1.0, 0.0) , vtype: 0 },
        Vertex3D { position: Vector3::new(0.146_446_62, 0.0, 0.853_553_4), normal: Vector3::new(-0.701, 0.0, -0.701), tex_coords: Vector2::new(0.0, 0.0) , vtype: 0 },

        Vertex3D { position: Vector3::new(0.146_446_62, 0.99, 0.853_553_4), normal: Vector3::new(-0.701, 0.0, -0.701), tex_coords: Vector2::new(0.0, 1.0) , vtype: 0 },
        Vertex3D { position: Vector3::new(0.853_553_4, 0.99, 0.146_446_62), normal: Vector3::new(-0.701, 0.0, -0.701), tex_coords: Vector2::new(1.0, 1.0) , vtype: 0 },
        Vertex3D { position: Vector3::new(0.853_553_4, 0.0, 0.146_446_62), normal: Vector3::new(-0.701, 0.0, -0.701), tex_coords: Vector2::new(1.0, 0.0) , vtype: 0 },
    ],

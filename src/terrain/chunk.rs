...
impl Chunk {
    ...
    pub fn update(&mut self) {
        ...
        fn flood_fill(lighting_array: &mut BlockDataArray<usize>, visited: &mut BlockDataArray<bool>, block_array: &BlockDataArray<usize>, block_index: &BlockIndex) {
        ...
        for x in 0..CHUNK_WIDTH {
            for y in 0..CHUNK_HEIGHT {
                for z in 0..CHUNK_WIDTH {
                    ...
                    flood_fill(&mut self.lighting, &mut visited, &self.blocks, &BlockIndex::new(x, y, z))
                }
            }
        }
